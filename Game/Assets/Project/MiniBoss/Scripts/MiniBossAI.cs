...
public class MiniBossAI : MonoBehaviour
{
    ...
    [SerializeField] private string[] attackAnimations = new string[] { "MiniBossAttack1", "MiniBossAttack2", "MiniBossAttack3" };
    ...
    {
        // Wait until animator actually switches to the named state
        int safety = 0;
        const int maxSafetyFrames = 300; // prevents infinite loop if state name mismatches
        ...
        // Now wait until the state's normalizedTime >= 1 (clip finished once)
        ...
        // small buffer to let transitions finish
    ...
    private IEnumerator AttackRoutine()
    {
        ...
        string chosenAnim = "MiniBossAttack1";
